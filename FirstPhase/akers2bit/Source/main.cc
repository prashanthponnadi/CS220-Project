...
int main(int argc,char* argv[]) {
	...
	akersobj.creatematrix(height, width); // create first
	...
	akersobj.akers_blockages(blockage_x, blockage_y,blockage_width, blockage_height);
	blockages.pop_back();
	
	}

		akersobj.readdata();
		akersobj.akers_search();
		akersobj.akers_traceback();
